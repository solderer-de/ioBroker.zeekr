...
```bash
iobroker url https://codeload.github.com/solderer-de/iobroker.zeekr/tar.gz/refs/tags/v0.1.35 zeekr --host iobroker --debug
```
...
sudo iobroker fix
sudo iobroker url https://codeload.github.com/solderer-de/iobroker.zeekr/tar.gz/refs/tags/v0.1.35 zeekr --host iobroker --debug
```
