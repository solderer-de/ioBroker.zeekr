...
```text
https://github.com/solderer-de/iobroker-adapter-zeekr/archive/refs/tags/v0.1.8.tar.gz
```

The equivalent CLI command is:

```bash
iobroker url https://github.com/solderer-de/iobroker-adapter-zeekr/archive/refs/tags/v0.1.8.tar.gz --host iobroker --debug
```
