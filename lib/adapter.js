...
// EXPERIMENTAL_* stammt aus borconi/openzeekr (Smali-Recherche, unverifiziert):
// nur neue Aktionen, keine Änderung bewährter Werte. Siehe README A/B-Checkliste.
const PARAMS = entries => ({ serviceParameters: entries.map(([key, value]) => ({ key, value })) });
const EXPERIMENTAL_COMMANDS = {
    trunkUnlock: { command: 'stop', serviceId: 'RDU', setting: PARAMS([['door', 'trunk']]) },
    trunkLock: { command: 'start', serviceId: 'RDL', setting: PARAMS([['door', 'trunk']]) },
    frunk: { command: 'start', serviceId: 'UFR', setting: {} },
    chargeLidOpen: { command: 'start', serviceId: 'RDO', setting: {} },
    defrostOn: { command: 'start', serviceId: 'RCE_2', setting: PARAMS([['RCE_HEAT', 'ENABLE']]) },
    defrostOff: { command: 'stop', serviceId: 'RCE_2', setting: PARAMS([['RCE_HEAT', 'DISABLE']]) },
    sunroofOpen: { command: 'start', serviceId: 'RWS_2', setting: PARAMS([['TARGET', 'SUNROOF']]) },
    sunroofClose: { command: 'stop', serviceId: 'RWS_2', setting: PARAMS([['TARGET', 'SUNROOF']]) },
    sentryOn: { command: 'start', serviceId: 'RSM', setting: PARAMS([['SETTING', 'RSM_THREE']]) },
    sentryOff: { command: 'stop', serviceId: 'RSM', setting: {} },
    engineStart: { command: 'start', serviceId: 'RES', setting: {} },
    engineStop: { command: 'stop', serviceId: 'RES', setting: {} },
    wake: { command: 'start', serviceId: 'RWR', setting: {} },
};
...
class ZeekrAdapter extends AdapterStub {
    ...
    async onMessage(obj) {
        ...
        if (obj && obj.command === 'stateChange') {
            ...
            const typedMatch = id?.match(
                /vehicles\.(.+)\.control\.(lock|unlock|climateStart|climateStop|chargeStart|chargeStop|windowsOpen|windowsClose|windowsVentilate|sunshadeOpen|sunshadeClose|flash|honkFlash|applyChargePlan|trunkUnlock|trunkLock|frunk|chargeLidOpen|defrostOn|defrostOff|sunroofOpen|sunroofClose|sentryOn|sentryOff|engineStart|engineStop|wake)$/,
            );
            const bridgeBase = () => ({
                username: this.config.username,
                password: this.config.password,
                ...
                try {
                    ...
                    if (typedAction === 'applyChargePlan') {
                        ...
                        const preset = TYPED_COMMANDS[typedAction] ||
                            EXPERIMENTAL_COMMANDS[typedAction] || {
                                command: typedAction,
                                serviceId: '',
                                setting: {},
                            };
        ...
        for (const vehicle of vehicles) {
            ...
            const states = [
                ...
                },
                {
                    ...
                    value: false,
                    common: { name: 'Send command', type: 'boolean', role: 'button', read: false, write: true },
                },
                {
                    id: `${idBase}.control.lock`,
                    value: false,
                    common: {
                        name: 'Lock vehicle (button)',
                        type: 'boolean',
                        role: 'button',
                        read: false,
                        write: true,
                ...
                },
                {
                    ...
                    value: false,
                    common: { name: 'Start charging (RCS)', type: 'boolean', role: 'button', read: false, write: true },
                },
                {
                    id: `${idBase}.control.chargeStop`,
                    value: false,
                    common: { name: 'Stop charging (RCS)', type: 'boolean', role: 'button', read: false, write: true },
                },
                {
                    id: `${idBase}.control.windowsOpen`,
                    value: false,
                    common: { name: 'Open windows', type: 'boolean', role: 'button', read: false, write: true },
                },
                {
                    id: `${idBase}.control.windowsClose`,
                    value: false,
                    common: { name: 'Close windows', type: 'boolean', role: 'button', read: false, write: true },
                },
                {
                    id: `${idBase}.control.windowsVentilate`,
                    value: false,
                    common: { name: 'Ventilate windows', type: 'boolean', role: 'button', read: false, write: true },
                },
                {
                    id: `${idBase}.control.sunshadeOpen`,
                    value: false,
                    common: { name: 'Open sunshade', type: 'boolean', role: 'button', read: false, write: true },
                },
                {
                    id: `${idBase}.control.sunshadeClose`,
                    value: false,
                    common: { name: 'Close sunshade', type: 'boolean', role: 'button', read: false, write: true },
                },
                {
                    id: `${idBase}.control.flash`,
                    value: false,
                    common: { name: 'Flash blinkers', type: 'boolean', role: 'button', read: false, write: true },
                },
                {
                    id: `${idBase}.control.honkFlash`,
                    value: false,
                    common: { name: 'Honk and flash', type: 'boolean', role: 'button', read: false, write: true },
                },
                {
                    id: `${idBase}.control.trunkUnlock`,
                    value: false,
                    common: {
                        name: 'Unlock trunk (experimental)',
                        type: 'boolean',
                        role: 'button',
                        read: false,
                        write: true,
                ...
                {
                    id: `${idBase}.control.trunkLock`,
                    value: false,
                    common: {
                        name: 'Lock trunk (experimental)',
                        type: 'boolean',
                        role: 'button',
                        read: false,
                        write: true,
                ...
                {
                    id: `${idBase}.control.frunk`,
                    value: false,
                    common: {
                        name: 'Open frunk (experimental)',
                        type: 'boolean',
                        role: 'button',
                        read: false,
                        write: true,
                ...
                {
                    id: `${idBase}.control.chargeLidOpen`,
                    value: false,
                    common: {
                        name: 'Open charge lid (experimental)',
                        type: 'boolean',
                        role: 'button',
                        read: false,
                        write: true,
                ...
                {
                    id: `${idBase}.control.defrostOn`,
                    value: false,
                    common: {
                        name: 'Defrost on (experimental)',
                        type: 'boolean',
                        role: 'button',
                        read: false,
                        write: true,
                ...
                {
                    id: `${idBase}.control.defrostOff`,
                    value: false,
                    common: {
                        name: 'Defrost off (experimental)',
                        type: 'boolean',
                        role: 'button',
                        read: false,
                        write: true,
                ...
                {
                    id: `${idBase}.control.sunroofOpen`,
                    value: false,
                    common: {
                        name: 'Open sunroof (experimental)',
                        type: 'boolean',
                        role: 'button',
                        read: false,
                        write: true,
                ...
                {
                    id: `${idBase}.control.sunroofClose`,
                    value: false,
                    common: {
                        name: 'Close sunroof (experimental)',
                        type: 'boolean',
                        role: 'button',
                        read: false,
                        write: true,
                ...
                {
                    id: `${idBase}.control.sentryOn`,
                    value: false,
                    common: {
                        name: 'Sentry on (experimental)',
                        type: 'boolean',
                        role: 'button',
                        read: false,
                        write: true,
                ...
                {
                    id: `${idBase}.control.sentryOff`,
                    value: false,
                    common: {
                        name: 'Sentry off (experimental)',
                        type: 'boolean',
                        role: 'button',
                        read: false,
                        write: true,
                ...
                {
                    id: `${idBase}.control.engineStart`,
                    value: false,
                    common: {
                        name: 'Remote engine start (experimental)',
                        type: 'boolean',
                        role: 'button',
                        read: false,
                        write: true,
                ...
                {
                    id: `${idBase}.control.engineStop`,
                    value: false,
                    common: {
                        name: 'Remote engine stop (experimental)',
                        type: 'boolean',
                        role: 'button',
                        read: false,
                        write: true,
                ...
                {
                    id: `${idBase}.control.wake`,
                    value: false,
                    common: {
                        name: 'Wake vehicle (experimental)',
                        type: 'boolean',
                        role: 'button',
                        read: false,
                        write: true,
    ...
    async ensureBatteryLog(idBase, vehicle) {
        const key = this.monthKey();
        await this.setObjectNotExistsAsync(`${idBase}.batteryLog`, {
            type: 'channel',
            common: { name: 'Battery log', type: 'channel' },
            native: {},
        });
