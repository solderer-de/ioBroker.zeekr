...
function canLoadAdapterCore() {
  ...
  const ioBrokerDataDir = process.env.IOB_DATA_DIR || process.env.IOBROKER_DATA_DIR;
  if (ioBrokerDataDir) {
    return true;
  }
  ...
  return candidateConfigPaths.some((candidatePath) => fs.existsSync(candidatePath));
}
